...
@section('content')
                ...
                <div class="box-header with-border">
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            <img src="{{asset('images/users/'.Auth::user()->avatar)}}" class="img-circle" width="128px" alt="Cinque Terre" height="auto">
                        </div>
                    </div>
                    <h2>
                        <br>
                       <strong>{{$usuarios->name}}</strong>
                    </h2>
    ...
    <div class="card">
        ...
        <div class="body">
            <div class="box-body">
                <!-- /.box-header -->
                {!!Form::model($usuarios,['id'=>'profile-form','method'=>'PATCH','files' => true,'route'=>['user.update',$usuarios->id]])!!}
                ...
                <div class="row col-xs-offset-0">
                    ...
                    <div class="col-sm-6">
                        <select class="selectpicker" name="puesto" data-width="100%">
                            <option selected>{{$usuarios->puesto}}</option>
                    ...
                    <div class="col-sm-6">
                        <select class="selectpicker" name="sucursal" data-width="100%">
                            <option selected>{{$usuarios->sucursal}}</option>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group label-floating">
                            ...
                            <input name="avatar" accept="image/*" id="input-id" type="file" class="form-control" data-preview-file-type="text" >
                        </div>
                    </div>
