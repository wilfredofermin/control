          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                 <a class="btn btn-raised btn-default" href="{{URL::action('UserController@show',Auth::user()->id )}}"><i class="fa fa-pencil-square-o"></i> Perfil</a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="principal.blade.php"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a>
            </li>
          </ul>
        </li>
        <li>
